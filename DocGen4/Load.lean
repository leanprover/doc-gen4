...
/--
Set up the lake environment, especially the search path and package information.
-/
...
/--
A convenience wrapper that loads and processes the specified modules.
-/
def load (modules : List Name) : IO AnalyzerResult := do
